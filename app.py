...
st.markdown(
      ...
      <body>
      `<div>
        <h1 style="background-color:yellow;padding:13px;color:red;font-size:50px;text-align: center;top: 50%;left: 50%;font-family:sans-serif;" >Car Price Prediction</h1>
